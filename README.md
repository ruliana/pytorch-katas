...
**Important Note**: Katas that haven't been reviewed by a human yet have the suffix `_unrevised.ipynb`. These may contain errors, inconsistencies, or unclear instructions, so please be mindful when working through them. We recommend starting with the fully reviewed katas first.
